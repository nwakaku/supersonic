...
class TwitterConnection(BaseConnection):
    def __init__(self, config: Dict[str, Any]):
        ...
        self.register_actions()  # Register actions during initialization

    def register_actions(self) -> None:
        """Register available actions for the Twitter connection"""
        self.actions = {
            "post-tweet": Action(
                name="post-tweet",
                parameters=[
                    ActionParameter("text", True, str, "The text content of the tweet"),
                    ActionParameter("media_ids", False, List[str], "List of media IDs to attach to the tweet")
                ],
            ...
            "fetch-tweets": Action(
                name="fetch-tweets",
                parameters=[
                    ActionParameter("user_id", True, str, "The ID of the user whose tweets to fetch"),
                    ActionParameter("count", False, int, "Number of tweets to fetch (default: 10)")
                ],
            ...
            "like-tweet": Action(
                name="like-tweet",
                parameters=[
                    ActionParameter("tweet_id", True, str, "The ID of the tweet to like")
                ],
            ...
            "retweet": Action(
                name="retweet",
                parameters=[
                    ActionParameter("tweet_id", True, str, "The ID of the tweet to retweet")
                ],
            ...
            "delete-tweet": Action(
                name="delete-tweet",
                parameters=[
                    ActionParameter("tweet_id", True, str, "The ID of the tweet to delete")
                ],
    ...
    def list_actions(self) -> List[Dict[str, Any]]:
        """List available actions for the Twitter connection"""
        actions = []
